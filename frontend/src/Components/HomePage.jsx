...
//         <h1 className="text-2xl font-bold text-blue-600">BuildingFix</h1>
...
//           <h2 className="text-4xl font-extrabold mb-4">Complaint & Maintenance Tracker</h2>
//           <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
//             A centralized platform for residents and building management. Report issues, 
//             track repairs in real-time, and stay updated with community events.
//           </p>
//         </section>
...
//             <h3 className="text-xl font-bold mb-2">For Residents</h3>
//             <ul className="list-disc ml-5 space-y-2 text-gray-600">
//               <li>Register complaints with images</li>
//               <li>Track status (Pending, In-Progress, Resolved)</li>
//               <li>View building announcements & events</li>
//               <li>Provide feedback on services</li>
//             </ul>
//           </div>

//           <div className="p-6 border rounded-lg bg-gray-50">
//             <h3 className="text-xl font-bold mb-2">For Management</h3>
//             <ul className="list-disc ml-5 space-y-2 text-gray-600">
//               <li>Assign tasks to maintenance staff</li>
//               <li>Manage inventory and parts</li>
//               <li>Generate resolution reports</li>
//               <li>Send emergency alerts to all residents</li>
//             </ul>
//           </div>
...
//         {}
//         <section className="bg-blue-50 p-10 rounded-2xl">
...
//               <p className="text-sm text-gray-600">MONGO DB(NoSQL)</p>
//             </div>
//             <div>
//               <p className="font-bold">Auth</p>
//               <p className="text-sm text-gray-600">Session Based</p>
//             </div>
//           </div>
//         </section>
...
//         <p>System Project © 2026 - Designed for Residential Efficiency</p>
//       </footer> */}
//     </div>
//   );
// };
